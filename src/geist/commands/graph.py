...
def rdflib(dataset, rankdir, mappings, on, outputroot, outputfile, outputformats):
    """Visualize an RDF dataset"""    
    from geist.datastore.rdflib import rdflib_graph
    rdflib_graph(dataset, rankdir, mappings, on, outputroot, outputfile, outputformats)
